    ...
    <div className={styles.formContainer}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.formGrid}>
        <div className={styles.formGroup}>
          <label>Имя:*</label>
          <input {...register("username", { required: "Введите имя" })} type="text" />
          {errors.username && <span className={styles.error}>{errors.username.message}</span>}
        </div>

        <div className={styles.formGroup}>
          <label>Фамилия:*</label>
          <input {...register("surName", { required: "Введите фамилию" })} type="text" />
        ...
        <div className={styles.formGroup}>
          ...
          <input {...register("phone", { required: "Введите телефон" })} type="tel" />
          {errors.phone && <span className={styles.error}>{errors.phone.message}</span>}
        </div>

        <div className={styles.formGroup}>
          <label>Фото (URL):*</label>
          <input {...register("avatar", { required: "Введите URL фото" })} type="text" />
